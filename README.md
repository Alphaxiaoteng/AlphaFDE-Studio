---
title: AICUT 电商口播短视频 AI 智能素材打靶工作台
emoji: 🎬
colorFrom: red
colorTo: orange
sdk: gradio
...
pinned: false
license: apache-2.0
short_description: 美妆/电商口播短视频 AI Agent 智能素材打靶 · 剪映 5.9 草稿一键导出工作台
---

# AICUT · 电商口播短视频 AI 智能素材打靶与剪辑工作台

> 🚀 **美妆/电商口播短视频 AI Agent 智能素材打靶 · 剪映 5.9 草稿导出 · Remotion 实时预览工作台**  
...
**AICUT** 是一款面向电商带货与短视频矩阵团队的 **AI 原生智能剪辑工作台**。

针对短视频爆款二创中“人工找素材繁琐”、“台词与画面脱节”、“剪映草稿拼装耗时”等行业痛点，通过自研的 **Agent Harness 语义打靶引擎**，自动解析口播台词逐字稿，从海量媒体库中秒级智能检索并精确打靶匹配最佳空镜、动作特写与对比镜头，并一键导出标准剪映工程草稿与视频渲染。
...
2. **🎞️ 专业级多轨道视频时间轴 (Remotion / Web Timeline)**：
   ...
   - 支持全屏独立工作台与内嵌模式。
3. **💄 美妆与电商跑量模板库**：
   - 内置千川跑量爆款模板（低饱和多用膏早八妆、水光麻薯腮红膏、控油散粉实测）；
   - 支持一键换肤与台词动态重组。
4. **📦 剪映 5.9 草稿与标准工程导出**：
