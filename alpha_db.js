...
exports.AlphaDatabaseClient = void 0;
...
class AlphaDatabaseClient {
    ...
    async handleRequest(path, opts = {}) {
        ...
        if (pathname === "/api/sop" && method === "POST") {
            ...
            if (!m)
                throw new Error(`match_id not found: ${body.match_id}`);
...
exports.AlphaDatabaseClient = AlphaDatabaseClient;
if (typeof window !== "undefined") {
    window.AlphaDB = new AlphaDatabaseClient();
}
//# sourceMappingURL=alpha_db.js.map